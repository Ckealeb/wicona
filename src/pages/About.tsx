  ...
  return (
    <div className="min-h-screen">
      <main className="flex-grow">
        <div className="campus-container py-8 sm:py-12 lg:py-16 bg-white">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-playfair font-bold text-gray-900 mb-4 sm:mb-6 text-center lg:text-left">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 mb-8 sm:mb-12">
            <div className="space-y-4 sm:space-y-6">
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900">Our Mission</h2>
              ...
              <h2 className="text-xl sm:text-2xl pt-2 sm:pt-4 font-extrabold text-gray-900">Our Vision</h2>
              <p className="text-gray-700 text-sm sm:text-base font-bold leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-12">
            <Card className="border-green-100 bg-white">
              <CardContent className="pt-4 sm:pt-6">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2 text-center text-gray-900">Expert Faculty</h3>
            ...
            <Card className="border-green-100 bg-white">
              <CardContent className="pt-4 sm:pt-6">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2 text-center text-gray-900">CBC Curriculum</h3>
                <p className="text-gray-700 text-sm sm:text-base text-center leading-relaxed">
            ...
            <Card className="bg-white border-green-100">
              <CardContent className="pt-4 sm:pt-6">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2 text-center text-gray-900">State-of-art Facilities</h3>
                <p className="text-gray-700 text-sm sm:text-base text-center leading-relaxed">
            ...
            <Card className="border-green-100 bg-white">
              <CardContent className="pt-4 sm:pt-6">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2 text-center text-gray-900">Student Success</h3>
                <p className="text-gray-700 text-sm sm:text-base text-center leading-relaxed">
