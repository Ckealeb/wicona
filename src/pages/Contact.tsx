            ...
            <div className="space-y-8">
              ...
              <div className="p-6 rounded-lg shadow-sm border border-green-100 bg-lime-200">
                ...
                <div className="flex flex-wrap gap-4">
                  <a href="https://twitter.com/wittscollege" target="_blank" rel="noopener noreferrer" 
                     className="flex items-center gap-2 p-2 bg-campus-blue text-white rounded-lg hover:bg-opacity-90 transition-all">
                    <Twitter size={20} />
                    <span>X (Twitter)</span>
                  </a>
                  <a href="https://instagram.com/wittscollege" target="_blank" rel="noopener noreferrer" 
                     className="flex items-center gap-2 p-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:bg-opacity-90 transition-all">
                    <Instagram size={20} />
                    <span>Instagram</span>
                  </a>
                  <a href="https://tiktok.com/@wittscollege" target="_blank" rel="noopener noreferrer" 
                     className="flex items-center gap-2 p-2 bg-black text-white rounded-lg hover:bg-opacity-90 transition-all">
                  ...
                  <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" 
                     className="flex items-center gap-2 p-2 bg-green-600 text-white rounded-lg hover:bg-opacity-90 transition-all">
