      ...
      <div className="campus-container py-12 bg-lime-900 rounded-sm">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm mb-4 text-campus-accent/90">
              Empowering students with knowledge and skills for the digital future.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="hover:text-campus-amber transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/about" className="hover:text-campus-amber transition-colors">About Us</Link></li>
              <li><Link to="/academics" className="hover:text-campus-amber transition-colors">Academics</Link></li>
              <li><Link to="/admissions" className="hover:text-campus-amber transition-colors">Admissions</Link></li>
              <li><Link to="/calendar" className="hover:text-campus-amber transition-colors">Academic Calendar</Link></li>
              <li><Link to="/portal" className="hover:text-campus-amber transition-colors">Student Portal</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/parent-resources" className="hover:text-campus-amber transition-colors">Parent Resources</Link></li>
              <li><Link to="/faculty" className="hover:text-campus-amber transition-colors">Faculty & Staff</Link></li>
              <li><Link to="/alumni" className="hover:text-campus-amber transition-colors">Alumni Network</Link></li>
              <li><Link to="/careers" className="hover:text-campus-amber transition-colors">Career Opportunities</Link></li>
              <li><Link to="/policies" className="hover:text-campus-amber transition-colors">Policies & Guidelines</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/20 text-sm text-center bg-lime-950">
          ...
          <div className="mt-2 space-x-4">
            ...
            <Link to="/terms" className="hover:text-campus-amber transition-colors">Terms of Use</Link>
            <Link to="/accessibility" className="hover:text-campus-amber transition-colors">Accessibility</Link>
          </div>
        </div>
      </div>
    </footer>;
