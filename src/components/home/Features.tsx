...
const Features = () => {
  const features = [{
    ...
    icon: <Download className="h-12 w-12 text-campus-amber bg-lime-400" />,
  ...
  return <section className="py-16 bg-gradient-to-b from-white to-campus-gray">
      <div className="campus-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
          {features.map(feature => <Card key={feature.id} className={`card-hover border-t-4 border-t-campus-blue shadow-md ${feature.color}`}>
              <CardHeader className="bg-lime-400">
              ...
              <CardFooter>
                <Link to={feature.link} className="text-campus-blue hover:text-campus-teal font-medium transition-colors flex items-center">
                  Learn More
