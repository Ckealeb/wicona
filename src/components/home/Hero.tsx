...
const Hero = () => {
  ...
  return (
    <div className="relative overflow-hidden h-[600px] md:h-[700px]">
      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="relative z-10 h-full flex flex-col justify-center items-center text-center text-white campus-container">
            ...
            <p className="text-lg md:text-xl mt-6 max-w-2xl animate-fade-in" style={{animationDelay: "0.2s"}}>
              {slide.subtitle}
            </p>
            <Link
              to={slide.ctaLink}
              className="mt-8 btn-accent inline-flex items-center animate-fade-in"
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-campus-blue bg-opacity-90 py-4 px-4 md:px-8 flex flex-wrap justify-center md:justify-around items-center gap-4 z-20">
